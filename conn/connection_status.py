...
class ConnectionStatus:
    ...
    def feed_uplink(self, packet: BasePacket):
        self._uplink_list.append((len(packet.pack()), self.get_cur()))
    ...
    def feed_downlink(self, packet: BasePacket):
        self.last_active = self.get_cur()
        self._downlink_list.append((len(packet.pack()), self.last_active))
